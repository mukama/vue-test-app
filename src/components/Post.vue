<template>
  <div class="post bg-white px-2 py-3 mb-4 pl-4 rounded shadow-lg flex" v-bind:class="{ slideInUp, slideInDown }">
    ...
    <div class="flex flex-col justify-center ml-auto">
      <button @click="moveUp(index)" class="p-2 rounded hover:bg-indigo-300" v-if="index > 0">
      ...
      <button @click="moveDown(index)" class="p-2 rounded hover:bg-indigo-300" v-if="index < 4">
